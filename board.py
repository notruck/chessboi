...
class DrawBoard:
    def __init__(self, fen, folder='chess', lastmove=None, upside_down=False, board_type=None, flip_pieces=False):
        self.fen = fen
        self.folder = folder
    ...
    def get_piece_img(self, piece):
        ...
        try:
            return Image.open(f'assets\\{self.folder}\\{colour}{piece}.png').convert('RGBA')
        except:
